<?php 
    ...
    $title = "Create Pelajaran | Smk Negeri Makassar";
            ...
            <main>
                <div class="container-fluid px-4">
                    <ol class="mt-4 breadcrumb mb-4">
                        <li class="breadcrumb-item active"><a href="<?= $url; ?>" class="text-decoration-none"><i class="fa-solid fa-house"></i> Dashboard</a> - <a href="" class="text-decoration-none">Data Pelajaran</a> - Form Pelajaran</li>
                    </ol>
                    
                    <!-- content -->
                    <div class="card">
                        <form action="function-pelajaran.php" method="post">
                            <div class="card-header">
                                <span class="h6"><i class="fa-solid fa-square-plus"></i> Form Tambah Pelajaran</span>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mb-4 row">
                                            ...
                                            <div class="col-sm-9" style="margin-left: -46px;">
                                                <input type="text" class="form-control  border-0 border-bottom" id="nama_mapel" name="nama_mapel">
                                            </div>
                                        </div>
                                        <div class="mb-4 row">
